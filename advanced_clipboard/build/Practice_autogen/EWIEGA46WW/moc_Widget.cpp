...
void Widget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->ShotTaken_1((*reinterpret_cast<std::add_pointer_t<QPixmap>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Widget::*)(QPixmap )>(_a, &Widget::ShotTaken_1, 0))
            return;
    }
}
...
// SIGNAL 0
void Widget::ShotTaken_1(QPixmap _t1)
{
